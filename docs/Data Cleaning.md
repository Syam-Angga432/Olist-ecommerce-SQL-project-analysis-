...
* untuk `invalid_carrier_delivery` dan `invalid_delivery_sequence` dengan total invalid timestamp 188, dikarenakan urutan timestamp yang salah akan di null-kan dikarenakan tidak bisa sembarangan menentukan durasi masing-masing order dan tetap Menjaga Integritas Analisis SLA.
